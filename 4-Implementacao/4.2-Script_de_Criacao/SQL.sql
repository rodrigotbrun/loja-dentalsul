...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`clientes` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `profissional` TINYINT(1) NOT NULL DEFAULT 0,
  ...
  `receber_informativos` TINYINT(1) NOT NULL DEFAULT 1,
  `receber_email` TINYINT(1) NOT NULL DEFAULT 1,
  `ativado` TINYINT(1) NOT NULL DEFAULT 0,
  `receber_sms` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`departamentos` (
  ...
  `menu_superior` TINYINT(1) NOT NULL DEFAULT 1,
  `menu_lateral` TINYINT(1) NOT NULL DEFAULT 0,
  `data_atualizado` DATETIME NOT NULL,
  `data_criado` DATETIME NOT NULL,
  `data_deletado` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`categorias` (
  ...
  `alias` VARCHAR(40) NOT NULL,
  `follow` TINYINT(1) NOT NULL DEFAULT 1,
  `palavras_chave` TEXT NULL DEFAULT NULL COMMENT '		',
  `indexar` TINYINT(1) NOT NULL DEFAULT 1,
  `menu_superior` TINYINT(1) NOT NULL DEFAULT 1,
  `visivel` TINYINT(1) NOT NULL DEFAULT 1,
  `menu_lateral` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`clientes_enderecos` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_cliente` INT UNSIGNED NOT NULL,
  `principal` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Endereço principal do cliente, DA CASA do cliente geralmente.',
  `entrega` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Endereço de entrega do cliente. Quando não existir um endereço de entrega com flag S, o endereço principal é considerado.',
...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`pedidos` (
  ...
  `ligacao` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`produtos` (
  ...
  `mostrar_busca` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Mostrar produto nos resultados da busca',
  ...
  `venda_sem_estoque` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Permitir venda de produtos sem estoque',
  ...
  `visivel` TINYINT(1) NULL DEFAULT 1,
  `estoque` DOUBLE NULL DEFAULT NULL COMMENT 'Quantidade em estoque do produto. ',
  `mostrar_vitrine` TINYINT(1) NOT NULL DEFAULT 1,
  ...
  `atacado` TINYINT(1) NOT NULL DEFAULT 0,
  ...
  `valor_frete_somar` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Flag que indica se o campo valor_frete deve ser somado com o calculo automático de frete.\n\nQuando S, valor_frete + Calculo no ato da compra do frete serão considerados. Quando N, apenas valor_frete sera considerado como frete do produto.',
  ...
  `permite_amostra` TINYINT(1) NOT NULL DEFAULT 0,
  `permite_pac` TINYINT(1) NOT NULL DEFAULT 1,
  `permite_sedex` TINYINT(1) NOT NULL DEFAULT 1,
  `permite_esedex` TINYINT(1) NOT NULL DEFAULT 0,
  `permite_transportadora` TINYINT(1) NOT NULL DEFAULT 0,
  ...
  `palavras_chave` TEXT NULL DEFAULT NULL,
  `follow` TINYINT(1) NOT NULL DEFAULT 1,
  `indexar` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Produto deve ser indexado por sistemas de busca\n',
  `desconto_pessoa` DOUBLE NULL DEFAULT 0 COMMENT 'Desconto do produto por pessoa. CAMPO EM PORCENTAGEM',
  `frete_individual` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'O frete do produto é calculado individualmente ou não. Quando individual, o frete e calculado separadamente para cada Unidade do produto em estoque. Só é válido para tipo_estoque = UND',
...
CREATE TABLE IF NOT EXISTS `loja_dentalsul`.`produtos_grade` (
  ...
  `mesmo_preco` TINYINT(1) NOT NULL DEFAULT 0,
  `visivel` TINYINT(1) NOT NULL DEFAULT 1,
  `data_criado` DATETIME NOT NULL,
  `data_atualizado` DATETIME NOT NULL,
  `data_deletado` DATETIME NULL DEFAULT NULL,
