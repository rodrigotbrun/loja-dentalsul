...
class Produto extends BaseModelSEO {
    ...
    protected $casts = [
        ...
        'lancamento' => 'boolean',
        'valor_frete' => 'float',
        'valor_frete_somar' => 'boolean',
        'frete_gratis' => 'boolean',
        'frete_gratis_regiao' => 'string',
        'comprimento' => 'float',
        'largura' => 'float',
        'altura' => 'float',
        'permite_amostra' => 'boolean',
        'permite_pac' => 'boolean',
        'permite_sedex' => 'boolean',
        'permite_esedex' => 'boolean',
        'permite_transportadora' => 'boolean',
